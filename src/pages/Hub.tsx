...
const APPS = [
  ...
  },
  {
    ...
    description: 'Crie landing pages otimizadas para vendas com edi��o simples de blocos, imagens e CTA. Pr�via em desktop e mobile antes de publicar.',
    icon: Layout,
  ...
  },
  {
    ...
    path: '/landing-page-builder',
    title: 'Construtor de Landing Pages',
    description: 'Crie landing pages otimizadas para vendas com edição simples de blocos, imagens e CTA. Prévia em desktop e mobile antes de publicar.',
    icon: Layout,
    accent: 'linear-gradient(135deg, #EA580C, #FF7A3D)',
    accentSolid: '#EA580C',
    accentLight: 'rgba(234,88,12,0.07)',
    accentBorder: 'rgba(234,88,12,0.18)',
    formats: ['Desktop', 'Mobile', 'Blocos editáveis'],
    badge: 'Landing Pages',
    status: 'stable' as const,
    destaque: false,
  }
